...
const Manager = () => {
  ...
  const showPassword = () => {
    ...
    if (ref.current.src.includes("public/eye.png")) {
      ref.current.src = "public/eye-close-up.png";
  ...
  return (
    <>
      ...
      <div className=" p-3 md:mycontainer min-h-[88.4vh] ">
        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          ...
          >
            <img className="w-5" src="public/bookmark.png" alt=""/>
            Save
          </button>
        </div>
                    ...
                    <tr key={index}>
                      <td className="py-2 border border-white text-center">
                        <div className="flex items-center justify-center ">
                          ...
                          >
                           <img className="w-6" src="public/copy.png" alt="" />
                          </div>
                        </div>
                      </td>
                      <td className="py-2 border border-white text-center">
                      ...
                      <td className=" flex justify-center py-2 border border-white text-center">
                        ...
                        >
                         <img className="w-6" src="public/edit-text.png" alt="" />
                        </span>
                        <span
                          className="cursor-pointer mx-1"
                          onClick={() => {
                        ...
                        >
                          <img className="w-6" src="public/bin.png" alt="" />
                        </span>
                      </td>
                    </tr>
                  );
